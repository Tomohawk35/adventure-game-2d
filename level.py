...
class Level:
    ...
    def create_map(self):
        layouts = {
            ...
            'entities': import_csv_layout('Zelda-main/05 - level graphics/5 - level graphics/map/map_Entities.csv')
        }
        graphics = {
                        ...
                        if style == 'entities':
                            if col == '394':
                                self.player = Player(
                                    ...
                                    self.create_attack, 
                                    self.destroy_attack, 
                                    self.create_magic) # passes method through to player without calling it
                            else:
